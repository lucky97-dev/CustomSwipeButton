...
import static com.lucky97.dev.customswipebutton.Constants.BTN_INIT_RADIUS;
import static com.lucky97.dev.customswipebutton.Constants.BTN_MORPHED_RADIUS;
import static com.lucky97.dev.customswipebutton.Constants.DEFAULT_SWIPE_DISTANCE;
import static com.lucky97.dev.customswipebutton.Constants.DEFAULT_TEXT_SIZE;
import static com.lucky97.dev.customswipebutton.Constants.MORPH_ANIM_DURATION;
import static com.lucky97.dev.customswipebutton.UiUtils.animateFadeHide;
import static com.lucky97.dev.customswipebutton.UiUtils.animateFadeShow;
import static com.lucky97.dev.customswipebutton.UiUtils.dpToPx;
   ...
   // private ImageView arrow2;
    ...
    private void setAttrs(Context context, AttributeSet attrs) {
        TypedArray a = context.getTheme().obtainStyledAttributes(
                attrs,
                R.styleable.CustomSwipeButton,
                0, 0);
        try {
            final String btnString = a.getString(R.styleable.CustomSwipeButton_btn_text);
            if (btnString != null)
                btnText = btnString;
            textColorInt = a.getColor(R.styleable.CustomSwipeButton_text_color, ContextCompat.getColor(context, android.R.color.black));
            bgColorInt = a.getColor(R.styleable.CustomSwipeButton_bg_color, ContextCompat.getColor(context, R.color.swipebtn_red));
            arrowColorInt = a.getColor(R.styleable.CustomSwipeButton_arrow_color, ContextCompat.getColor(context, R.color.swipebtn_translucent_white));
            btnRadius = a.getFloat(R.styleable.CustomSwipeButton_btn_radius, BTN_INIT_RADIUS);
            textSize = a.getDimensionPixelSize(R.styleable.CustomSwipeButton_text_size, (int) DEFAULT_TEXT_SIZE);
        } finally {
            a.recycle();
        }
    }
    ...
    public void init() {
        ...
        view = inflater.inflate(R.layout.view_customswipe, this, true);
    }
    ...
    public void updateBackground() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN) {
            ...
            contentContainer.setBackgroundResource(R.drawable.bg);
        } else {
            contentContainer.setBackgroundResource(R.drawable.bg);
    ...
    private void showProgressBar() {
        ...
        progressBar.getIndeterminateDrawable().setColorFilter(ContextCompat.getColor(context, android.R.color.black), PorterDuff.Mode.SRC_IN);
        animateFadeHide(context, contentTv);
